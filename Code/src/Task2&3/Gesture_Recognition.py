...
def Gesture():
	file_location = '/home/pradeep/Documents/Project_Smart_Lab/Gesture-Recognition-and-controlling-an-automation-environment-master/Code/src/Task2/ACC.csv'
	...
	for a in range(0, axis):
		for i in range(0, kmax):
			for j in range(0, number_of_features):
				X[1,feature_count] = feature[a, i, j]
