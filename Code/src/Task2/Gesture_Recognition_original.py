...
for n in range(0,Total_data):
	file_location = '/home/pradeep/Documents/Project_Smart_Lab/Gesture-Recognition-and-controlling-an-automation-environment-master/Code/src/Task2/ACC_' + str(n) + '.csv'
	#excelfile = '/home/pradeep/Documents/Project_Smart_Lab/Gesture-Recognition-and-controlling-an-automation-environment-master/Code/src/Task2/ACC_' + str(n) + '.xlsx'
	...
	kmax = N  # No of Frames
	number_of_training_samples = 302
	...
	for a in range(0,axis):
		for i in range(0,kmax):
		    gesture[n, a, i, 0] = feature[a,i,0] = u[a,i]
		    #print('gesture = ' + str(gesture[n, a, i, 0]) + ' feature = ' + str(feature[a,i,0]))
		    gesture[n, a, i, 1] = feature[a,i,1] = energy[a,i]
		    #print('gesture = ' + str(gesture[n, a, i, 1]) + ' feature = ' + str(feature[a, i, 1]))
		    gesture[n, a, i, 2] = feature[a,i,2] = entropy[a,i]
		    #print('gesture = ' + str(gesture[n, a, i, 2]) + ' feature = ' + str(feature[a, i, 2]))
		    gesture[n, a, i, 3] = feature[a,i,3] = standard_deviation[a,i]
		    #print('gesture = ' + str(gesture[n, a, i, 3]) + ' feature = ' + str(feature[a, i, 3]))
		    gesture[n, a, i, 4] = feature[a,i,4] = corelation[a,i]
		    #print('gesture = ' + str(gesture[n, a, i, 4]) + ' feature = ' + str(feature[a, i, 4]))
